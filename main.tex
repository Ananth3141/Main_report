...
\paragraph{Diverging critical mode.} Near the bifurcation point $r_c$, the system undergoes critical fluctuations where variance along the primary Order Parameter mode--- the critical direction $\be_1(r)$---diverges, while fluctuations along all transverse modes $\be_{k\geq 2}$ remain bounded.\\
...
\end{equation*}
Here, "direction" refers specifically to the principal eigenvector $\be_1$ corresponding to the dominant eigenvalue $\lambda_1(r)$. Along this eigenvector, variance grows parametrically faster then in any orthogonal subspace:
\begin{equation*}
...
\sgp{What is student model, write a small paragraph on your approach to this model. What are you going to gain/find out from the model predictions?}\ant{Has been addressed below}
