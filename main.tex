...
One of the successes of modern Machine learning models is due to the generalization capability of the model \sgp{find \& cite different famous papers} where the model is able to accurately predict the solution to problems not in the training dataset. While this capability is the selling point of several of the foundational models, the mechanism behind this generalization is less understood.
