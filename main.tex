...
\begin{figure}[h]
     \centering 
     \includegraphics{figures/fig1_trajectories_and_covariance.pdf}
...
\begin{figure}[H]
    \centering 
    \includegraphics{figures/M_v_delta.pdf}
    \label{fig:m_v_delta}
    \caption{Add caption}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics{figures/b_v_delta.pdf}
    \label{fig:b_v_delta}
    \caption{Add caption}
\end{figure}
...
\begin{equation*}\mathbb{E}[\eta\eta^T] = O(1) \end{equation*}
